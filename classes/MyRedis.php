...
class _MyRedis
{
	 ...
	 * @param MyRedisKey $key			The key to delete
	 * @return void
	 */
	public static function delete(/*string*/ $server, MyRedisKey $key)
	{
		// Get the connection
	 ...
	 * @param MyRedisKey				The key to update
	 * @param uint $ttl					The time in seconds before expiration
	 * @return void
	 */
	public static function expire(/*string*/ $server, MyRedisKey $key, /*uint*/ $ttl)
	{
		// Get the connection
		$oRedis = self::fetchConnection($server, 'write');
	 ...
	 * @param MyRedisKey $key			The key to search for
	 * @return mixed
	 */
	public static function get(/*string*/ $server, MyRedisKey $key)
	{
		// Get the connection
	 ...
	 * @param MyRedisKey[] $keys		The keys to look for
	 * @return array
	 */
	 ...
	 * @param MyRedisKey $key			The key to the hash
	 * @param string $hash				If set, only this element in the hash will be returned
	 * @param mixed
	 */
	public static function hashGet(/*string*/ $server, MyRedisKey $key, /*string*/ $hash = null)
	{
		// Get the connection
		$oRedis = self::fetchConnection($server, 'read');
	 ...
	 * @return int
	 */
	public static function hashIncrement(/*string*/ $server, MyRedisKey $key, /*string*/ $hash)
	{
		// Get the connection
		$oRedis = self::fetchConnection($server, 'write');
	 ...
	 * @param void
	 */
	public static function hashSet(/*string*/ $server, MyRedisKey $key, /*string|array*/ $hash, /*mixed*/ $value = null)
	{
		// Get the connection
		$oRedis = self::fetchConnection($server, 'write');
	 ...
	 * @param MyRedisKey				The key to the value
	 * @return void
	 */
	public static function increment(/*string*/ $server, MyRedisKey $key, /*uint*/ $incr_by = 1)
	{
		// Get the connection
		$oRedis = self::fetchConnection($server, 'write');
	 ...
	 * @param MyRedisKey $key			They key to the list
	 * @return uint
	 */
	public static function listLen(/*string*/ $server, MyRedisKey $key)
	{
		// Get the connection
		$oRedis = self::fetchConnection($server, 'read');
	 ...
	 * @param MyRedisKey $key			The key to the list
	 * @return mixed
	 */
	public static function listPop(/*string*/ $server, MyRedisKey $key)
	{
		// Get the connection
		$oRedis = self::fetchConnection($server, 'write');
	 ...
	 * @return void
	 */
	public static function listPush(/*string*/ $server, MyRedisKey $key, /*mixed*/ $value)
	{
		// Get the connection
		$oRedis = self::fetchConnection($server, 'write');
	 ...
	 * @return array
	 */
	public static function listRange(/*string*/ $server, MyRedisKey $key, /*int*/ $start = 0, /*int*/ $end = -1)
	{
		// Get the connection
		$oRedis = self::fetchConnection($server, 'read');
	 ...
	 * @return mixed
	 */
	public static function listShift(/*string*/ $server, MyRedisKey $key)
	{
		// Get the connection
		$oRedis = self::fetchConnection($server, 'write');
	 ...
	 * @return void
	 */
	public static function listTrim(/*string*/ $server, MyRedisKey $key, /*int*/ $start, /*int*/ $end)
	{
		// Get the connection
		$oRedis = self::fetchConnection($server, 'write');
	 ...
	 * @return void
	 */
	public static function listUnshift(/*string*/ $server, MyRedisKey $key, /*mixed*/ $value)
	{
		// Get the connection
		$oRedis = self::fetchConnection($server, 'write');
	 ...
	 * @param MyRedisKey $key			The key to set
	 * @param mixed $value				The value to set on the key
	 * @param uint $ttl					If set, a TTL will be set on the key
	 * @return bool
	 */
	public static function set(/*string*/ $server, MyRedisKey $key, /*mixed*/ $value, /*uint*/ $ttl = 0)
	{
		// Get the connection
		$oRedis = self::fetchConnection($server, 'write');
